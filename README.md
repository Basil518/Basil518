...
* Выявление и сбор требований: интервью, воркшопы, опросники и т.д.
* Понимание процессов разработки ПО (SDLS)
...
* Построение UML диаграмм: последовательности, классов, вариантов использования, активности
* Описание User Stories, проектирование Use Case, написание формализолванных функциональных и нефункциональных требований, критериев верификации по рекоменлдациям INCOSE и К.Виггерса.
...
* Анализ и моделирование архитектуры в С4, взаимодействия систем.  
